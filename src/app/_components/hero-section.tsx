...
export default function HeroSection() {
  ...
  const features = [
    ...
    {
      title: 'UX Design',
      description: `Great UX isn't just about how things look; it's about creating experiences that feel effortless and intuitive. I dive deep to understand what both the business *and* the user need.`,
      icon: <SquarePenIcon className='size-6' />,
    },
    {
      title: 'Service Design & Strategy',
      description: `Service Design looks beyond the screen.I help organizations identify pain points and opportunities by designing services that work seamlessly behind the scenes and deliver real value.`,
    ...
    <div className='px-4 w-full md:px-6 2xl:max-w-[1200px] 2xl:mx-auto py-24 md:py-32'>
      ...
      <div className='mx-auto max-w-3xl text-center mb-10'>
        <p className='text-xl text-muted-foreground'>
          ...
          strategy, or both, I&apos;m here to help shape projects that
